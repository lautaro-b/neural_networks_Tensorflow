...
def affine_layer(input_tensor, output_dim, layer_name, act=tf.nn.sigmoid):
    """
...
middle = affine_layer(hidden, 200, 'middle')
prediction = affine_layer(middle, 10, 'pred', act=tf.identity)
